...
class _MyJournalState extends State<MyJournal> {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          if (acc.isEmpty) {
            showDialog(
              context: context,
              builder: (context) => contentBox(context),
            );
          } else {
          ...
          itemBuilder: (context, index) {
            return Padding(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => OpenTrade(
                      startday: DateFormat('dd-MM-yyyy')
                          .format(weekDays[index].startDate),
                      endDay: DateFormat('dd-MM-yyyy')
                          .format(weekDays[index].endDate),
                    ),
                  ));
                },
                child: Container(
                  decoration: BoxDecoration(
                    boxShadow: [
                      BoxShadow(
                        ...
                        spreadRadius:
                            2, // Adjust spread and blur for desired effect
                        blurRadius: 5,
                        offset:
                            Offset(0, 3), // Adjust offset for shadow position
                      ),
                    ],
                        ...
                        IconButton(
                            onPressed: () async {
                              final pickedDate = await showDatePicker(
                                ...
                                firstDate: DateTime(
                                    2000, 1), // Optional: Set minimum date
                                lastDate: DateTime
                                    .now(), // Optional: Set maximum date
                              );
                              if (pickedDate != null &&
                                  pickedDate != _selectedDate) {
                                setState(() {
                                  _selectedDate = pickedDate;
                                  _calender.text = DateFormat('dd-MM-yyyy')
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        // ...
                          ...
                          debugPrint(
                              "new entry data is $newcurrency,${_calender.text},${entry.text},${lot.text},${SL.text},${profit.text}");
                          JournalData newEntry = JournalData(
                              ...
                              longShort: longShort);
                          debugPrint(
                              "dateformat is ${DateFormat('dd-MM-yyyy').format(_selectedDate)}");
                          ...
                          debugPrint(
                              "dateformat is $date and $mounted and $friday");
                          Trade trade =
                              Trade(startDate: monday, endDate: friday);
                          setState(() {});
  ...
  Widget customRadio(
      BuildContext context, String text, Color col, Color border) {
    return Card(
      elevation: 10,
      child: new Container(
        //height: 50.0,
        ...
        decoration: new BoxDecoration(
          ...
          //   ),
          // ],
          border: new Border.all(width: 2.0, color: border),
                            ...
                            TextButton(
                              onPressed: () async {
                                ...
                                AccountHistory history = AccountHistory(
                                    amount: double.parse(balance.text),
                                    name: "Initial Depopsit",
                                    date: _calender.text,
...
// Insert the new entry into the database
                                ...
                                List<AccountData> dat =
                                    await dbHelper.getAccountData();
